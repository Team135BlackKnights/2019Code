...
public class LineUpS extends Command {
  ...
  protected void execute() {
    ...
    } else if (targetExists && limelightData[Limelight.HORIZONTAL_OFFSET] > 0.0) // If Target is to the Right, turn to
                                                                                 // the Right
    {
      Robot.driveTrain.TurnDriveTrain(TURNING_MOTOR_POWER, DriveTrain.DirectionToTurn.Right);
    } else if (targetExists && limelightData[Limelight.HORIZONTAL_OFFSET] < 0.0) // If Target is to the Left, turn to
                                                                                 // the Left
    {
      Robot.driveTrain.TurnDriveTrain(TURNING_MOTOR_POWER, DriveTrain.DirectionToTurn.Left);
    } else {
